...
export default function Step4() {
  ...
  return (
    <>
      {/* Final Team Reminder Modal */}
      <NoticeModal
        open={welcomeModalOpen}
        onClose={() => setWelcomeModalOpen(false)}
        onContinue={() => setWelcomeModalOpen(false)}
        title='FINAL REMINDER'
        message='You are almost done! Please remember that to complete your verification and get approved, you must update your profile information and upload your boxer/fighter sparring contents.'
        continueLabel='Got It, Let’s Finish!'
      />
      ...
      >
        ...
        >
          ...
          {/* Back to step 3 */}
          <CustomAuthButton
            onClick={() => navigate(`/sign-up/step3?${params.toString()}`)}
            variant='contained'
          >
            Back
          </CustomAuthButton>
