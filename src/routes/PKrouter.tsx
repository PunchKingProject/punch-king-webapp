...
const Adminlayout = Loadable(
  lazy(() => import('../layouts/Adminlayout.tsx'))
);

const UserLayout = Loadable(
  lazy(() => import('../layouts/UserLayout.tsx'))
);

const TeamLayout = Loadable(
  lazy(() => import('../layouts/TeamLayout.tsx'))
);
...
const SignInPage = Loadable(
  lazy(() => import('../pages/sign-in/SignInPage.tsx'))
);
...
const TermsPage = Loadable(
  lazy(() => import('../pages/legal/TermsPage.tsx'))
);
...
const Step1 = Loadable(
  lazy(() => import('../pages/sign-up/steps/Step1.tsx'))
);

const Step2 = Loadable(
  lazy(() => import('../pages/sign-up/steps/Step2.tsx'))
);

const Step3 = Loadable(
  lazy(() => import('../pages/sign-up/steps/Step3.tsx'))
);
...
const Preview = Loadable(
  lazy(() => import('../pages/sign-up/steps/Preview.tsx'))
);

const Welcome = Loadable(
  lazy(() => import('../pages/sign-up/Welcome.tsx'))
);
...
const AccountProfilePage = Loadable(
  lazy(() => import('../pages/account/AccountProfilePage.tsx'))
);

const AccountSecurityPage = Loadable(
  lazy(() => import('../pages/account/AccountSecurityPage.tsx'))
);
...
const AdminNewsEventsPage = Loadable(
  lazy(() => import('../pages/admin/NewsEvents/NewsEventsPage.tsx'))
);

const AdminTeamPostsPage = Loadable(
  lazy(() => import('../pages/admin/TeamPosts/TeamPostsPage.tsx'))
);
...
const TeamMySponsorshipsDetailsPage = Loadable(
  lazy(
    () =>
      import('../pages/team/MySponsorship/MySponsorshipDetailsPage.tsx')
  )
);
  ...
  createRoutesFromElements(
    <>
      ...
      */}
      ...
      {/*
      |--------------------------------------------------------------------------
      | Admin Routes (Wrapped in Adminlayout to display Sidebar)
      |--------------------------------------------------------------------------
      */}
      ...
      >
        ...
        {/* Team Posts Management Route */}
        <Route
          path='team-posts'
          element={<AdminTeamPostsPage />}
        />
      ...
      */}
      ...
      >
        ...
        <Route
          ...
          element={<UserMySponsorshipsPage />}
        />
      ...
      */}
      ...
      >
        ...
        <Route
          path='my-licensing'
          element={<TeamMyLicensingPage />}
        />

        <Route
          path='my-licensing/payments'
          element={<LicensePaymentPage />}
        />

        <Route
          path='my-sponsorship'
          element={<TeamMySponsorshipPage />}
        />
